...
public class GloriaRomanusController {
  ...
  public void clickedInvadeButton(ActionEvent e) throws IOException {
    if (currentlySelectedHumanProvince != null && currentlySelectedEnemyProvince != null) {
      ...
      if (confirmIfProvincesConnected(humanProvince, enemyProvince)) {
        ...
        if (choice == 0) {
          // human won. Transfer 40% of troops of human over. No casualties by human, but enemy
          // loses all troops
  ...
  private void addAllPointGraphics() throws JsonParseException, JsonMappingException, IOException {
    ...
    for (org.geojson.Feature f : fc.getFeatures()) {
      if (f.getGeometry() instanceof org.geojson.Point) {
        ...
        Point curPoint =
            new Point(coor.getLongitude(), coor.getLatitude(), SpatialReferences.getWgs84());
   ...
   * FeatureTable.queryFeaturesAsync() pass string to QueryParameters.setWhereClause() as the query
   * string
   */
