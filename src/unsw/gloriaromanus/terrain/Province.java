...
public class Province
    ...
    public Province(String name) {
        ...
        // Set tax level
        this.setTaxLevel(TaxLevel.NORMAL_TAX);
    }
    ...
    public void setTaxLevel(TaxLevel taxLevel) {
        ...
        else if ((this.tax.getTaxLevel().getTaxRate() >= TaxLevel.VERY_HIGH_TAX.getTaxRate())
    ...
    public JSONObject serialize() {
        ...
        json.put("taxLevel", this.tax.getTaxLevel().getTaxRate());
